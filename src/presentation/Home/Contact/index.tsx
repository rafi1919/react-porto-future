                    ...
                    <div className='w-full flex text-center justify-center h-[50vh] bg-primary rounded-b-[50px]'>
                      <div className='parallax-container'>
                        ...
                        <div className='flex flex-row gap-4 items-center justify-center font-medium mt-7'>
                          <p className='py-2 px-5 lg:text-base md:text-[11px] text-[8px] rounded-full border-[1px] border-blackDark text-primary w-fit bg-blackDark'><Link to="https://www.instagram.com/ralfiantz/?hl=en">CONTACT NOW</Link></p>
